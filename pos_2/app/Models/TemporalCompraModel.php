...
class TemporalCompraModel extends Model{
    ...
    // esto de hace para ver si el producto ya se encuentra en la compra 


    // con get los resultados son objetos
    // con find la respuesta es como se definio en el modelo(eso creo )
