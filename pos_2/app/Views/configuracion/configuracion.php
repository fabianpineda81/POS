<div id="layoutSidenav_content">
  <main>
    <div class="container-fluid">
      <h4 class="mt-4"><?php echo $titulo ?></h4> <?php if (isset($validation)) { ?>
      ...
      <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>/configuracion/actualizar" autocomplete="off">
        ...
        <div class="from-group">
          ...
          <div class="row mb-3">
            ...
            <div class="col-12 col-sm-6">
              ...
              <textarea class="form-control" id="tienda_direccion" name="tienda_direccion" type="text" required> <?php echo  $direccion['valor'] ?> </textarea>

            </div>

            <div class="col-12 col-sm-6">
              <label>leyenda del tikect</label>
              <textarea class="form-control" id="ticket_leyenda" name="ticket_leyenda" type="text" required><?php echo  $leyenda['valor'] ?> </textarea>
        ...
        <div class="form-group">
            <div class="row">
              ...
              <img src="<?php echo base_url().'/images/logotipo.jpg' ?>" alt="" class="img-responsive" width="200"> 
