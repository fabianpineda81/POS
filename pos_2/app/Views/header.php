        ...
        <ul class="navbar-nav ml-auto  mr-md-3 my-2 my-md-0">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                    <a class="dropdown-item" href="<?php echo  base_url()?>/usuarios/cambiar_password">Cambiar contraseña</a>
                    <a class="dropdown-item" href="#">Activity Log</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?php echo  base_url()?>/usuarios/logout">Cerrar seccion</a>
                </div>
            </li>
        </ul>
    </nav>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?php echo base_url()?>/ventas/venta"><i class="fas fa-cash-register"></i> Caja </a>
                            <a class="nav-link" href="<?php echo base_url()?>/ventas"><i class="fas fa-shopping-cart"></i> Ventas</a>
                            ...
                            <div class="collapse" id="subAdministracion" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="<?php echo base_url()?>/cajas">Roles</a>
